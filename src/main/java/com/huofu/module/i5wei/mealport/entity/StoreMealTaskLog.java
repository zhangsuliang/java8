...
import com.huofu.module.i5wei.mealport.dbrouter.StoreMealTaskLogDbRouter;

/**
 * 出餐口与Pad的任务关系日志表
 */
@Table(name = "tb_store_meal_task_log", dalParser = StoreMealTaskLogDbRouter.class)
public class StoreMealTaskLog extends AbsEntity {
